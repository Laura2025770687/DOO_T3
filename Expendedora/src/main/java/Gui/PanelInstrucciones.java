...
public class PanelInstrucciones extends JPanel {
    public PanelInstrucciones(ProxyExp Proxy) {
        ...
        this.setMaximumSize(new Dimension(470,200));
        ...
        JLabel instr3 = new JLabel("<html><center>3. Retire el producto y su vuelto, si <br> corresponde.</center></html>", SwingConstants.CENTER);
